...
if __name__ == '__main__':
    ...
    lists = ['eyebrows-and-lashes', 'massage', 'spa', 'gym-and-fitness']
    for l in lists:
        content = get_page_content('https://www.fresha.com/for-business/{}'.format(l))
        create_html_page('{}.html'.format(l), content)